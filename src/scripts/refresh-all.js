...
(async () => {
  ...
  db.close();
  console.log(`  resolved: ${syncResult.pending.resolved}, failed: ${syncResult.pending.failed}`);
  console.log(`  renamed (refresh pass): ${syncResult.refresh.updated}, unchanged: ${syncResult.refresh.unchanged}`);
})();
